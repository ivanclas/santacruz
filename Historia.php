...
<div class="form-group">
    ...
    <input type="date" name="fecha_nacimiento" id="fecha_nacimiento" readonly>
</div>
...
$(document).ready(function () {
    $('#dni').on('blur', function () {
        var dni = $(this).val();
        $.ajax({
            url: 'obtener_nombre.php', // Archivo PHP para buscar el paciente en la base de datos
            method: 'POST',
            data: { dni: dni },
            dataType: 'json',
            success: function (response) {
                if (response && response.nombre && response.fecha_nacimiento) {
    ...
    <a href="ver_historias.php" class="ver-button">Ver Historias</a>
</body>
</html>
